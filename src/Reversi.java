    ...
    class MouseProc extends MouseAdapter{
        ...
        public void mouseClicked(MouseEvent player){
            ...
            if(point.x >= wScale && point.x <= 9*wScale && point.y > hScale && point.y <= 9*hScale){
                ...
                if(btn == MouseEvent.BUTTON3 && tunrn == 2){
                    for(int i = 2; i<=9; i++){
                        if(point.x <= i*wScale){
                            x = i-2;
                            break;
                ...
                if(cnt > 0){
                    ...
                    else if(board.numGridBlack == 0 && tunrn == 2 || board.numGridWhite == 0 && tunrn == 1) MessageDialog();
                    else changeTurn();
                }
            }
        }
